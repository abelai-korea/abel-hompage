...
const PAIN_POINTS = [
  {
    title: '광고를 꺼면 사라지는 병원, 이유 모를 AI 무응답',
...
const SOLUTIONS = [
  ...
  },
  {
    ...
    desc: '우리 병원 이름으로만 유입이 일어나는 것은 SEO 마케팅이 아닙니다. 환자들이 밤늦게 통증과 증상에 대해 절박하게 묻는 ‘탐색 질문’(80%)과, 신뢰를 얻고 예약을 결정하는 ‘최종 질문’(20%)이 홈페이지 내부 구조에 최적의 비율로 잘 매핑되어 있는지 검색 노출 기회를 진단합니다.',
