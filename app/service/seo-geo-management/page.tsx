...
const WHY_ABEL = [
  {
    title: "매달 버려지는 소모성 마케팅이 아닌, 영구히 축적되는 병원의 '자산형 콘텐츠'",
  ...
  },
  {
    ...
    desc: '전문가들만 아는 테크니컬 마케팅 약어나 은어 보고서로 속이지 않습니다. 매달 실제 일어난 순수 오가닉 잠재 고객의 유입 증가량과 최종 예약 문의 건수의 증가 추이 등 가장 핵심적인 비즈니스 성장 지표 위주로 정기 브리핑을 제공합니다.',
  },
];
